...
export const CODE_FONT_SIZE_OPTIONS = buildNumericOptions(9, 18, 1)
...
export const CODE_LINE_HEIGHT_OPTIONS = buildNumericOptions(1.2, 2, 0.05)
export const HEADING_LINE_HEIGHT_OPTIONS = buildNumericOptions(1, 2, 0.05)
