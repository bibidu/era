...
import { TitleComposerSheet } from './TitleComposerSheet'
...
export function TitleComposerPrototype() {
  ...
  const [sheetHeight, setSheetHeight] = useState(() => readCachedTitleSheetHeight())
  ...
  return (
    <div className="title-composer">
      <div className="title-composer__stage">
        ...
        <div className="title-composer__preview-slot">
          <TitlePreview
            doc={doc}
      ...
      <TitleComposerSheet height={sheetHeight} onHeightChange={setSheetHeight}>
        <BreakPointBar
          doc={doc}
          selectedLineId={selectedLine?.id ?? null}
          activeTool={activeTool}
