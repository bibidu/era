...
name: fengshui
description: >-
  【风水skill】阳宅/风水主题社媒图文：Era 风水模板 + 诗意泥纸页背景、活学活用改写（知识点为骨、教导为皮肉）、4–6 页分篇（多篇文案一次齐发确认连贯）、同篇诗意背景同色调、入库发图。
...
1. 文案阶段：把**上 / 中 / 下各篇正文一次全部发出**（均去掉 page-break），方便用户检查分篇是否连贯、衔接是否断裂。禁止只丢上篇、藏着中下篇。
...
6. 本篇全部诗意背景图同色调（同一 `paper` / 辅色；非高亮色）；文案符合活学活用改写方向
